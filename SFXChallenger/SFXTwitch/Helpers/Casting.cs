...
/*
 ...
 Casting.cs is part of SFXTwitch.
...
using SFXTwitch.Library.Extensions.NET;
using SharpDX;
using MinionManager = SFXTwitch.Library.MinionManager;
using MinionOrderTypes = SFXTwitch.Library.MinionOrderTypes;
using MinionTeam = SFXTwitch.Library.MinionTeam;
using MinionTypes = SFXTwitch.Library.MinionTypes;
using Spell = SFXTwitch.Wrappers.Spell;
using TargetSelector = SFXTwitch.SFXTargetSelector.TargetSelector;

#endregion

namespace SFXTwitch.Helpers
{

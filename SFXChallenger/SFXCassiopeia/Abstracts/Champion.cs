...
/*
 ...
 Champion.cs is part of SFXCassiopeia.
...
using SFXCassiopeia.Menus;
using MinionManager = SFXCassiopeia.Library.MinionManager;
using MinionOrderTypes = SFXCassiopeia.Library.MinionOrderTypes;
using MinionTeam = SFXCassiopeia.Library.MinionTeam;
using MinionTypes = SFXCassiopeia.Library.MinionTypes;
using Orbwalking = SFXCassiopeia.SFXTargetSelector.Orbwalking;
using Spell = SFXCassiopeia.Wrappers.Spell;
using TargetSelector = SFXCassiopeia.SFXTargetSelector.TargetSelector;

#endregion

namespace SFXCassiopeia.Abstracts
{

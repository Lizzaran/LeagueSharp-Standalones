...
/*
 ...
 SFXSafeJungleSpot.cs is part of SFXSafeJungleSpot.
...
using SFXSafeJungleSpot.Library.Extensions.NET;
...
{
    public class SFXSafeJungleSpot
    {
        private bool _unloadTriggered;

        public SFXSafeJungleSpot()
        {
            try
            {

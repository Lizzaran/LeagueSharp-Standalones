...
/*
 ...
 Global.cs is part of SFXSafeJungleSpot.
...
using System.IO;
using System.Linq;
using SFXSafeJungleSpot.Interfaces;
using SFXSafeJungleSpot.Library;
using SFXSafeJungleSpot.Library.Logger;

#endregion

namespace SFXSafeJungleSpot
{
    public class Global
    {
        ...
        public static string Name = "SFXSafeJungleSpot";
        public static string UpdatePath = "Lizzaran/LeagueSharp-Dev/master/Sentryfox-Standalones/SFXUtility/SFXSafeJungleSpot";
        ...
        public static SFXSafeJungleSpot SFX = null;

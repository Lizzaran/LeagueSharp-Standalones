...
/*
 ...
 TurnAround.cs is part of SFXTurnAround.
...
using SFXTurnAround.Library.Extensions.NET;
...
{
    internal class TurnAround : Child<App>
    {
        ...
        public TurnAround(App parent) : base(parent)
        {
            OnLoad();
        }

...
using SFXClock.Classes;
using SFXClock.Library.Logger;

#endregion

namespace SFXClock.Features.Drawings
{
    internal class Clock : Child<App>
    {
        public Clock(App parent) : base(parent)
        {
            OnLoad();
        }

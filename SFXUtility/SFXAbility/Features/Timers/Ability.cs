...
/*
 ...
 Ability.cs is part of SFXAbility.
...
using SFXAbility.Classes;
using SFXAbility.Library.Extensions.NET;
...
namespace SFXAbility.Features.Timers
{
    internal class Ability : Child<App>
    {
        ...
        public Ability(App parent) : base(parent)
        {
            OnLoad();
        }

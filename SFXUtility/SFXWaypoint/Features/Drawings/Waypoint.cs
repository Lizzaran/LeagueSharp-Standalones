...
/*
 ...
 Waypoint.cs is part of SFXWaypoint.
...
using SFXWaypoint.Classes;
using SFXWaypoint.Library;
using SFXWaypoint.Library.Extensions.SharpDX;
...
namespace SFXWaypoint.Features.Drawings
{
    internal class Waypoint : Child<App>
    {
        ...
        public Waypoint(App parent) : base(parent)
        {
            OnLoad();
        }

...
/*
 ...
 SFXWallJumpSpot.cs is part of SFXWallJumpSpot.
...
using SFXWallJumpSpot.Library.Extensions.NET;
using SFXWallJumpSpot.Library.Logger;
using Version = System.Version;

#endregion

namespace SFXWallJumpSpot
{
    public class SFXWallJumpSpot
    {
        private bool _unloadTriggered;

        public SFXWallJumpSpot()
        {
            try
            {

...
/*
 ...
 PerfectWard.cs is part of SFXPerfectWard.
...
using SFXPerfectWard.Classes;
using SFXPerfectWard.Library.Extensions.SharpDX;
...
namespace SFXPerfectWard.Features.Drawings
{
    internal class PerfectWard : Child<App>
    {
        ...
        public PerfectWard(App parent) : base(parent)
        {
            OnLoad();
        }

...
/*
 ...
 SFXAutoLeveler.cs is part of SFXAutoLeveler.
...
using SFXAutoLeveler.Library.Extensions.NET;
using SFXAutoLeveler.Library.Logger;
using Version = System.Version;

#endregion

namespace SFXAutoLeveler
{
    public class SFXAutoLeveler
    {
        private bool _unloadTriggered;

        public SFXAutoLeveler()
        {
            try
            {

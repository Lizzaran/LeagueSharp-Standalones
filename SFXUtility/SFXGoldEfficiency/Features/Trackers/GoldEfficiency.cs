...
/*
 ...
 GoldEfficiency.cs is part of SFXGoldEfficiency.
...
using SFXGoldEfficiency.Classes;
using SFXGoldEfficiency.Library;
using SFXGoldEfficiency.Library.Extensions.SharpDX;
...
namespace SFXGoldEfficiency.Features.Trackers
{
    internal class GoldEfficiency : Child<App>
    {
        ...
        public GoldEfficiency(App parent) : base(parent)
        {
            OnLoad();
        }

...
/*
 ...
 SFXGoldEfficiency.cs is part of SFXGoldEfficiency.
...
using SFXGoldEfficiency.Library.Extensions.NET;
...
{
    public class SFXGoldEfficiency
    {
        private bool _unloadTriggered;

        public SFXGoldEfficiency()
        {
            try
            {

...
/*
 ...
 AutoJump.cs is part of SFXAutoJump.
...
using SFXAutoJump.Classes;
using SFXAutoJump.Library;
...
namespace SFXAutoJump.Features.Activators
{
    internal class AutoJump : Child<App>
    {
        ...
        public AutoJump(App parent) : base(parent)
        {
            OnLoad();
        }

...
/*
 ...
 SFXLasthitMarker.cs is part of SFXLasthitMarker.
...
using SFXLasthitMarker.Library.Extensions.NET;
...
{
    public class SFXLasthitMarker
    {
        private bool _unloadTriggered;

        public SFXLasthitMarker()
        {
            try
            {

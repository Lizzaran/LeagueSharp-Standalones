...
/*
 ...
 SFXDamageIndicator.cs is part of SFXDamageIndicator.
...
using SFXDamageIndicator.Classes;
using SFXDamageIndicator.Library.Extensions.NET;
...
{
    public class SFXDamageIndicator
    {
        private bool _unloadTriggered;

        public SFXDamageIndicator()
        {
            try
            {

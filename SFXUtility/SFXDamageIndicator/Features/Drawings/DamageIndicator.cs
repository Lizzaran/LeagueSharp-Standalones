...
/*
 ...
 DamageIndicator.cs is part of SFXDamageIndicator.
...
namespace SFXDamageIndicator.Features.Drawings
{
    internal class DamageIndicator : Child<App>
    {
        ...
        public DamageIndicator(App parent) : base(parent)
        {
            OnLoad();
        }

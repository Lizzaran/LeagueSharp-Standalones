...
/*
 ...
 LastPosition.cs is part of SFXLastPosition.
...
using SFXLastPosition.Library.Extensions.SharpDX;
using SFXLastPosition.Library.Logger;
using SFXLastPosition.Properties;
using SharpDX;
...
{
    internal class LastPosition : Child<App>
    {
        ...
        public LastPosition(App parent) : base(parent)
        {
            OnLoad();
        }

...
/*
 ...
 SFXLaneMomentum.cs is part of SFXLaneMomentum.
...
using SFXLaneMomentum.Library.Extensions.NET;
...
{
    public class SFXLaneMomentum
    {
        private bool _unloadTriggered;

        public SFXLaneMomentum()
        {
            try
            {

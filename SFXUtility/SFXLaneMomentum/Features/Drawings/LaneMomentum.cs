...
/*
 ...
 LaneMomentum.cs is part of SFXLaneMomentum.
...
using SFXLaneMomentum.Classes;
using SFXLaneMomentum.Library;
...
namespace SFXLaneMomentum.Features.Drawings
{
    internal class LaneMomentum : Child<App>
    {
        ...
        public LaneMomentum(App parent) : base(parent)
        {
            OnLoad();
        }

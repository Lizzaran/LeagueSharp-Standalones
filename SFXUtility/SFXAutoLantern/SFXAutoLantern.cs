...
/*
 ...
 SFXAutoLantern.cs is part of SFXAutoLantern.
...
using SFXAutoLantern.Library.Extensions.NET;
...
{
    public class SFXAutoLantern
    {
        private bool _unloadTriggered;

        public SFXAutoLantern()
        {
            try
            {

...
/*
 ...
 AutoLantern.cs is part of SFXAutoLantern.
...
using SFXAutoLantern.Classes;
using SFXAutoLantern.Library;
using SFXAutoLantern.Library.Logger;

#endregion

namespace SFXAutoLantern.Features.Others
{
    internal class AutoLantern : Child<App>
    {
        private GameObject _lantern;

        public AutoLantern(App parent) : base(parent)
        {
            OnLoad();
        }

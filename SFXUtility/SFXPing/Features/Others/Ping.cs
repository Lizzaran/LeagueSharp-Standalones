...
using SFXPing.Classes;
using SFXPing.Library.Extensions.SharpDX;
...
namespace SFXPing.Features.Others
{
    internal class Ping : Child<App>
    {
        private readonly List<PingItem> _pingItems = new List<PingItem>();
        private Font _text;

        public Ping(App parent) : base(parent)
        {
            OnLoad();
        }

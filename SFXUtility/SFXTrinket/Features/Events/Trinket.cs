    ...
    internal class Trinket : Child<App>
    {
        ...
        protected override sealed void OnLoad()
        {
            try
            {
                ...
                levelMenu.AddItem(new MenuItem(levelMenu.Name + "Enabled", "Enabled").SetValue(true));
                ...
                eventsMenu.AddItem(new MenuItem(eventsMenu.Name + "Enabled", "Enabled").SetValue(true));

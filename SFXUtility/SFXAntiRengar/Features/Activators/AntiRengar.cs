...
/*
 ...
 AntiRengar.cs is part of SFXAntiRengar.
...
using SFXAntiRengar.Classes;
using SFXAntiRengar.Library;
using SFXAntiRengar.Library.Logger;

#endregion

namespace SFXAntiRengar.Features.Activators
{
    internal class AntiRengar : Child<App>
    {
        ...
        public AntiRengar(App parent) : base(parent)
        {
            OnLoad();
        }

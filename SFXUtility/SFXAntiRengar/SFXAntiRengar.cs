...
/*
 ...
 SFXAntiRengar.cs is part of SFXAntiRengar.
...
using SFXAntiRengar.Library.Extensions.NET;
...
{
    public class SFXAntiRengar
    {
        private bool _unloadTriggered;

        public SFXAntiRengar()
        {
            try
            {

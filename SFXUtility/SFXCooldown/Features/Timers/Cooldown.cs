...
/*
 ...
 Cooldown.cs is part of SFXCooldown.
...
using SFXCooldown.Classes;
using SFXCooldown.Data;
using SFXCooldown.Library;
using SFXCooldown.Library.Extensions.NET;
using SFXCooldown.Library.Extensions.SharpDX;
using SFXCooldown.Library.Logger;
using SFXCooldown.Properties;
using SharpDX;
...
namespace SFXCooldown.Features.Timers
{
    internal class Cooldown : Child<App>
    {
        ...
        public Cooldown(App parent) : base(parent)
        {
            OnLoad();
        }

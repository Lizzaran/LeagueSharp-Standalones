...
/*
 ...
 Potion.cs is part of SFXPotion.
...
using SFXPotion.Classes;
using SFXPotion.Library;
using SFXPotion.Library.Extensions.NET;
using SFXPotion.Library.Logger;
using ItemData = LeagueSharp.Common.Data.ItemData;

#endregion

namespace SFXPotion.Features.Activators
{
    internal class Potion : Child<App>
    {
        ...
        public Potion(App parent) : base(parent)
        {
            OnLoad();
        }

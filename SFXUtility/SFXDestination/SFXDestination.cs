...
/*
 ...
 SFXDestination.cs is part of SFXDestination.
...
using SFXDestination.Library.Extensions.NET;
...
{
    public class SFXDestination
    {
        private bool _unloadTriggered;

        public SFXDestination()
        {
            try
            {

...
/*
 ...
 Destination.cs is part of SFXDestination.
...
using SFXDestination.Classes;
using SFXDestination.Library;
...
namespace SFXDestination.Features.Trackers
{
    // Credits: Screeder

    internal class Destination : Child<App>
    {
        ...
        public Destination(App parent) : base(parent)
        {
            OnLoad();
        }

...
/*
 ...
 Jungle.cs is part of SFXJungle.
...
using SFXJungle.Library;
using SFXJungle.Library.Extensions.NET;
using SFXJungle.Library.Extensions.SharpDX;
...
namespace SFXJungle.Features.Timers
{
    internal class Jungle : Child<App>
    {
        ...
        public Jungle(App parent) : base(parent)
        {
            OnLoad();
        }
